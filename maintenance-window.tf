#Maintenance windows for scan operations
...
#Maintenance window target via tag for scan operations
...
# Command task (AWS-RunPatchBaseline) associated to the maintenance window for scan operations
